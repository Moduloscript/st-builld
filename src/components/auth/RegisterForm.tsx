  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-6">
      <div className="space-y-2">
        <h1 className={`text-2xl font-bold text-center ${poppins.className}`}>Create Account</h1>
        <p className="text-center text-default-500">
          Join St Peter&apos;s Pharmacy for personalized health services
        </p>
      </div>
      ...
      <div className="space-y-4">
        <Input
          ...
          startContent={<User className="text-emerald-600 dark:text-emerald-400" size={18} />}
          variant="bordered"
          classNames={{
        ...
        <Checkbox
          ...
          classNames={{
            ...
            wrapper: "before:border-emerald-500/20 group-hover:before:border-emerald-500",
          }}
        >
          I agree to the{' '}
          <Link
